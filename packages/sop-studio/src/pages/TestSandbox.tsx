...
export default function TestSandbox() {
  ...
  const hasConditions =
    currentStep?.conditions && Object.keys(currentStep.conditions).length > 0;
          ...
          {finished ? (
            ...
            <>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                {currentStep.criteria &&
                  Object.keys(currentStep.criteria).length > 0 && (
                    <div className="mt-4 bg-gray-50 rounded-md p-4">
                      <h3 className="text-sm font-semibold text-gray-700 mb-2">
                        Criteria
                      </h3>
                      <dl className="space-y-1">
                        {Object.entries(currentStep.criteria).map(
                          ([key, value]) => (
                ...
                {/* Tool Suggestions */}
                {currentStep.tool_suggestions &&
                  currentStep.tool_suggestions.length > 0 && (
                ...
                {hasConditions ? (
                  <div>
                    ...
                    <div className="space-y-2">
                      {Object.entries(currentStep.conditions!).map(
                        ([condKey, condValue]) => (
                          <button
                            key={condKey}
                            type="button"
                            onClick={() =>
                              handleConditionSelect(condKey, condValue.action)
                            }
                  ...
                  <div className="flex justify-end">
                    ...
                    >
                      {currentStepIndex >= decisionTree.length - 1
                        ? "Finish"
                        : "Next Step"}
                      <svg
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
              <p className="text-gray-500">
                No decision tree steps found in this SOP.
              </p>
            </div>
          )}
