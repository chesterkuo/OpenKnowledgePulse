...
const stats: Stat[] = [
  { value: "639", label: "テスト", color: "var(--kp-teal)" },
  { value: "6", label: "MCP ツール", color: "var(--kp-blue)" },
  { value: "200K+", label: "スキル", color: "var(--kp-orange)" },
...
const testimonials: Testimonial[] = [
  {
    initials: "AK",
    color: "var(--kp-teal)",
    quote: "KnowledgePulse は、AI エージェントがチーム間でナレッジを共有する方法を根本的に変えました。",
    name: "Alex Kim",
    role: "ML エンジニア",
  },
  {
    initials: "SR",
    color: "var(--kp-blue)",
    quote: "SOP Studio のおかげで、以前は文書化されていなかった専門家のプロセスをキャプチャできるようになりました。",
  ...
  },
  {
    initials: "JC",
    color: "var(--kp-orange)",
    quote: "異なる AI フレームワークを横断して機能するナレッジプロトコルがようやく登場しました。",
    name: "James Chen",
    role: "AI アーキテクト",
  },
];
