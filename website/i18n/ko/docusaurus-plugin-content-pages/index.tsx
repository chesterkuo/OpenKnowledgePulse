...
const stats: Stat[] = [
  { value: "639", label: "테스트", color: "var(--kp-teal)" },
  { value: "6", label: "MCP 도구", color: "var(--kp-blue)" },
  { value: "200K+", label: "스킬", color: "var(--kp-orange)" },
...
const testimonials: Testimonial[] = [
  {
    initials: "AK",
    color: "var(--kp-teal)",
    quote: "KnowledgePulse는 우리 AI 에이전트가 팀 간에 지식을 공유하는 방식을 완전히 바꿨습니다.",
    name: "Alex Kim",
    role: "ML 엔지니어",
  },
  {
    initials: "SR",
    color: "var(--kp-blue)",
    quote: "SOP 스튜디오 덕분에 이전에는 문서화되지 않았던 전문가 프로세스를 캡처할 수 있게 되었습니다.",
  ...
  },
  {
    initials: "JC",
    color: "var(--kp-orange)",
    quote: "마침내 서로 다른 AI 프레임워크 간에 작동하는 지식 프로토콜이 생겼습니다.",
    name: "James Chen",
    role: "AI 아키텍트",
  },
];
